...
exports.ListsModule = ListsModule = __decorate([
    (0, common_1.Module)({ imports: [contacts_module_1.ContactsModule], controllers: [lists_controller_1.ListsController], providers: [lists_service_1.ListsService], exports: [lists_service_1.ListsService] })
], ListsModule);
